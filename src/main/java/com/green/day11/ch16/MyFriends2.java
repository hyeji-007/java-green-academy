...
public class MyFriends2 {
    ...
    public static void main(String[] args) {
        ...
        //타입이 다른데 문제가 발생하지 않는다 >> 다형성, 다양한 타입으로 저장될 수 있다. >> 상속 관계에서만 가능
        ...
        Friend[] arr3 = new Friend[10]; //arr3의 각방의 타입: Friend
        //univFriend2, CompFriend2, Friend 객체 주소값 모두 담을 수 있는 배열 (부모타입은 자식 객체의 주소값을 담을 수 있다)
        arr3[0] = obj1;
        arr3[1] = f2; //UnivFriend2 객체의 주소값
        ...
        //main 메소드는 수정 금지!!!
        // 이름,전번 + 대학친구는 전공도 출력, 직장동료는 부서도 출력
...
class CompFriend2 extends Friend {
   ...
   //private Friend friend; >> has-A 관계
