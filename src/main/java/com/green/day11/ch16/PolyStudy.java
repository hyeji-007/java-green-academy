...
public class PolyStudy {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------");
        //1번 검증
        Animal ani1 = new Cat(); //자동 형변환, 부모 타입인 Animal은 자식 객체의 주소값을 담을 수 있다. (Cat, Dog...)
        Animal ani2 = new Dog();
        ...
        //dog1에는 BullDog 객체 주소값이 저장되어 있었기 때문에 문제없다.
        ...
        System.out.println(ani3 instanceof BullDog); //true (형변환 가능)
