...
public class SystemOutPrintLn {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("3 + 5 = " + 8); // 문자열 + 정수: 정수가 자동 형변환이 되어 문자열이 된다.
        System.out.println(3.15 + "는 실수입니다."); // 실수 + 문자열: 실수가 자동 형변환되어 문자열이 된다.

        /*
        문자열과 더하기가 만나면 다른형은 무조건 문자열로 자동 형변환이 된다.
