...
public class PrimitiveVsReferenceTest {
    ...
    public static void main(String[] args) {
        ...
        NumberBox nb = new NumberBox(); // 1. nb에는 주소값이 저장되어 있다.(0x111)
        nb.num = 10;
        ChangeNum(nb); //nb: numberBox 객체 주소값
        System.out.println("nb.num: " + nb.num); // 4. 100
    ...
    public static void ChangeNum(NumberBox nb) { // 2. 다른 공간이지만 같은 주소값(0x111)
