...
public class ArrayStudy {
    ...
    그렇지만 배열을 사용하여 여러 데이터를 편하게 저장하고 가져올 수 있다.
    (read / write)

    배열 만드는 방법
    int[] 변수명 = new int[100];
    //100개의 정수값을 저장할 수 있는 공간을 만들었다.
    String[] 변수명 = new String[100];
    //100개의 문자열을 저장할 수 있는 공간을 만들었다.
    ...
    초기화 하지 않은 공간에 디폴트값이 들어간다.(저장되어있다)
    ...
    메소드명({1, 2, 3}); //이렇게 호출하는 것이 안된다. >> 타입 x
