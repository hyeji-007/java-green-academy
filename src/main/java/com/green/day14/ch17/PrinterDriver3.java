...
public class PrinterDriver3 {
    public static void main(String[] args) {
        ...
        //ColorPrintable cp = (ColorPrintable)new Prn204Drv(); //자식 타입으로 부모객체의 주소값 담을 수 없다, ColorPrintable에만 printCMYK 메소드를 가지고 있다.
        //cp.printCMYK("ddd");
    }
}
...
class Prn909Drv implements ColorPrintable { //ColorPrintable >> Printable

    @Override
    public void printCMYK(String doc) {
        System.out.println("From MD-909 CMCK ver");
