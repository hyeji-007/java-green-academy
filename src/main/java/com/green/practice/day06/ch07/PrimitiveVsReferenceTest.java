...
public class PrimitiveVsReferenceTest {
    ...
    public static void main(String[] args) {
        ...
        changeNum(num); //changeNum(int num)과 공간이 다르다.(스코프 다름) >> primitive 타입 특.
        System.out.println("num: " + num); //num: 10

        /*
        main메소드에 있는 num변수(main-num)와 changeNum메소드에 있는 num매개변수(m-num)는
        다른 공간이다. main-num이 가지고 있는 값을 복사해서 m-num에 저장했다.
        m-num값을 변경한다고 하여 main-num값이 변경되는 것은 아니다.
        왜? 다른 공간(스코프)이기 때문
         */
    ...
    다만, 같은 주소값을 가지고 있다. 그로 인해 같은 객체에 접근할 수 있다.
    ...
    public static void changeNum(NumberBox nb) { 2. 다른 공간이지만 같은 주소값(0x3)
           nb.num = 100; // 3. 10 >> 100 (같은 객체의 주소값을 공유하기 때문에 접근이 가능함
    }
     */
